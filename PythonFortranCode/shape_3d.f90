...
!
      ...
      REAL(RK), INTENT(IN)  :: vec(10, 3), pnt(*)
...
!     
      ...
      REAL(RK), INTENT(IN)  ::  coords(0:nelem1, 0:kdim1)
      
      REAL(RK), INTENT(OUT)  ::  dndx(0:nelem1, 0:nnpe)
      REAL(RK), INTENT(OUT)  ::  dndy(0:nelem1, 0:nnpe)
      REAL(RK), INTENT(OUT)  ::  dndz(0:nelem1, 0:nnpe)

      REAL(RK), INTENT(OUT)  ::  det(0:nelem1)
      
      REAL(RK), INTENT(OUT)  ::  ijac11(0:nelem1), ijac12(0:nelem1)
      REAL(RK), INTENT(OUT)  ::  ijac13(0:nelem1), ijac21(0:nelem1)
      REAL(RK), INTENT(OUT)  ::  ijac22(0:nelem1), ijac23(0:nelem1)
      REAL(RK), INTENT(OUT)  ::  ijac31(0:nelem1), ijac32(0:nelem1)
      REAL(RK), INTENT(OUT)  ::  ijac33(0:nelem1)
!     
!     Locals.
!     
...
!     
      ...
      REAL(RK)  ::  jac11(0:nelem1)
      REAL(RK)  ::  jac12(0:nelem1)
      REAL(RK)  ::  jac13(0:nelem1)
!     
      REAL(RK)  ::  jac21(0:nelem1)
      REAL(RK)  ::  jac22(0:nelem1)
      REAL(RK)  ::  jac23(0:nelem1)
!     
      REAL(RK)  ::  jac31(0:nelem1)
      REAL(RK)  ::  jac32(0:nelem1)
      REAL(RK)  ::  jac33(0:nelem1)
!
      integer io
!     
!----------------------------------------------------------------------
